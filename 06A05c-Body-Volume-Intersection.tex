\subsection{\secState{R}Body-volume Intersection}\label{s:bodyvolumeIntersection}
...
\newpage\paragraph{Space Intersection Rate - Body Volume:} The \emph{body volume mass} with center at $position(t)$ is moving along intruder trajectory prediction (eq. \ref{eq:linearintersectionmodelVehicleVolume}) in time interval $[0,\infty[$:
