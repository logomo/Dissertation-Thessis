\subsection{(R) U-Space (EU)}\label{sec:USpace}
...
\begin{note}
    ...
    The \emph{separation minima} for \emph{UAS - Manned aviation} is unreasonably huge (2 nautical miles) and in current proposal it is more like the moving constraint.
\end{note}
