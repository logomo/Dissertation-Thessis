...
\paragraph{Configurability:} The \emph{Rule Engine} enables real time configuration. The \emph{Enabled Rule Table} have been implemented to enforce specific rules in specific context. 
