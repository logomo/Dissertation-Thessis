...
\begin{enumerate}
    ...
    \item \emph{Avoidance Grid Run} (sec. \ref{R) Avoidance Grid Run}\label{s:aviudabceGridRun}) (inner avoidance run) - the \emph{best path finding} in one \emph{Avoidance Grid} with \emph{situation assessment} done.
