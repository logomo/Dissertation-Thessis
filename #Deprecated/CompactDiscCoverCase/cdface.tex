...
\cdrdisk{
  ...
  \vskip11em
  %%% CHANGE THIS %%%
  {\fontsize{10pt}{1em}\selectfont \textbf{Obstacle Avoidance Framework based on Reach Sets}}

  \vskip1.5em
  %%% CHANGE THIS %%%
  {\fontsize{9pt}{1em}\selectfont Alojz Gomola}\\
  {\fontsize{7pt}{1em}\selectfont Programa Doutoral em Matemática Aplicada}\\[-0.3em]
  {\fontsize{7pt}{1em}\selectfont Departamento de Matemática}\\[0.3em]
  %
  %
  %
  {\fontsize{12pt}{1em}\selectfont \textbf{2019}}
}
