...
\newpage\noindent Let us take \emph{Rule-based Head on} test case (sec. \ref{s:testRuleHeadOn}), changing only following aspects:
\begin{enumerate}
...
\begin{enumerate}
    ...
    \item \emph{Storm scenario} - the overall \emph{computation load} is very low due to the \emph{moving constraint implementation} (def. \ref{def:movingConstraint}).
