...
The \emph{harm prioritization} is addressed by higher navigation logic (fig. \ref{Mission control run activity diagram.}). All \emph{sources of harm} are considered as equal. Threat is formalized in \emph{following definition}:
...
\begin{table}[H]
    ...
    \begin{tabular}{c|ccc}
        ...
        Visibile & $visibility(c_{i,j,k})$&$\ge$&$(1-threshold)$ \\\hline
