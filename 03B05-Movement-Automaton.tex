\section{\secState{R}Movement Automaton}\label{sec:MovementAutomatonBackground}
    ...
    \subsection{\secState{D}Hybrid Automaton}\label{s:HybridAutomaton}
...
\subsection{\secState{D}Definition}\label{s:MovementAutomatonDefinitionAndProperties}
