\section{\secState{R}Aircraft Operational Rules}\label{sec:AircraftOperationRules}
...
\subsection{\secState{R}Visual Flight Rules}\label{sec:VisualFlightRules}
...
\subsection{\secState{R}Instrumental Flight Rules}\label{sec:InstrumentalFlightRules}
