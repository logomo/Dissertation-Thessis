...
The \emph{maneuverability uncertainty intersection} (sec. \ref{s:uncertaintyIntersection}) is tuned through the uncertainty spread on horizontal and vertical plane. This spread can not be infinite and the only limitation is given by implementation:
