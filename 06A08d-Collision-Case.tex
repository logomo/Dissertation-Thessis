...
The \emph{Movement Automaton} can be used as trajectory prediction for initialsystem state and future movements.  The prediction function (eq. \ref{eq:statePredictionCollisionCase}).
