...
\paragraph{Reach Sets:} These challenges are addressable by the  employment of \emph{reach sets} (sec. \ref{s:ReachSets}). The \emph{reach set} is a set of possible maneuvering strategies for some initial UAS state and some time-period. 
