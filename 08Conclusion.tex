\cleardoublepage
\chapter{\secState{W}Conclusion and Future Work}\label{ch:Conclusion}
...
\section{\secState{W}Lessons learned}
...
\section{\secState{W}Future Work}
\begin{enumerate}
